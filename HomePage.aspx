...
<body style="height: 486px; z-index: 1; left: 0px; top: 0px; position: absolute; width: 1208px">
    <form id="form1" runat="server">
    <div style="height: 136px; width: 1207px">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p>
            ...
            <asp:Button ID="cookingButton" runat="server" style="font-size: medium" Text="Cooking" />
            <asp:Button ID="romanceButton" runat="server" style="font-size: medium" Text="Romance" Width="101px" />
            <asp:Button ID="fantasyButton" runat="server" style="font-size: medium" Text="Fantasy" Width="93px" />
            <asp:Button ID="top100Button" runat="server" style="font-size: medium" Text="Top 10 Most Popular" Width="211px" />
        </p>
        <h2 style="width: 328px">Welcome to Best Books</h2>
        <p style="width: 328px; height: 153px; z-index: 1; left: 0px; top: 263px; position: absolute">
            ...
            mollit anim id est laborum.&quot;</span><asp:Image ID="logoImage" runat="server" style="z-index: 1; left: 3px; top: -259px; position: absolute; height: 114px; width: 201px" />
        </p>
        ...
        <asp:Image ID="bestBooksImage" runat="server" style="z-index: 1; left: 909px; top: 242px; position: absolute; height: 185px; width: 291px" />
        <asp:Image ID="readingImage" runat="server" ImageUrl="~/UserDefinedImages/books-open-on-table.jpg" style="z-index: 1; left: 501px; top: 245px; position: absolute; height: 136px; width: 262px" />
        <asp:HyperLink ID="top100Link" runat="server" style="z-index: 1; left: 531px; top: 385px; position: absolute">Top 100 Books of 2017</asp:HyperLink>
        <p>
            &nbsp;</p>
        ...
        <asp:HyperLink ID="todaysDealsLink" runat="server" style="z-index: 1; left: 1018px; top: 431px; position: absolute">Today&#39;s Deals</asp:HyperLink>
        <p>
            &nbsp;</p>
        <p>
            &nbsp;</p>
